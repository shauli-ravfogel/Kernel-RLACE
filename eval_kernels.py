...
if __name__ == "__main__":
    ...
    for filename in os.listdir("./interim/glove{}/kernel/preimage".format(run_id)):
        ...
        #if "laplace" not in filename: continue
        ...
        for kernel_type in ["rbf", "poly","laplace","sigmoid","linear","mlp"]:
            ...
            if kernel_type == "mlp":
                ...
                if kernel_type == "UniformMK":
                    ...
                    model = SVC(kernel=easymkl_func.__call__)
            ...
            score_same=None     
            if kernel_type == params_dict["kernel-type"] and kernel_type not in ["EasyMKL", "UniformMK"]:
            ...
            print("-----------------------------------")
        print("=================================================")            
    with open("interim/glove{}/kernel/preimage/eval/scores.pickle".format(run_id), "wb") as f:
